...
class RequestContext {
    ...
    get send() {
        // console.log("--fx--",this.url);
        var hostname = this.url.hostname;
        if(this.url.hostname == 'html5.api.gamedistribution.com' && this.url.pathname == '/main.min.js'){
            console.log(1);
